...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact' | 'twoSection';
    colorVariant: 'light' | 'dark' | 'gray' | 'blue' | 'green';
...
export interface CallToActionBlock {
  layout?: ('center' | 'left') | null;
  width?: ('full-width' | 'inline') | null;
  richText?: {
    root: {
      type: string;
      children: {
...
export interface ContentBlock {
  sectionType?: ('columnLayout' | 'twoSection') | null;
  sectionWidth: 'fullWidth' | 'container';
  colorVariant?: ('white' | 'grey' | 'black' | 'blue' | 'green') | null;
  columns?:
    | {
